...
#-- set I/O delay
set_input_delay  [expr $TEST_CYCLE*0] -clock clk [remove_from_collection [all_inputs] [get_ports clk]]
set_output_delay [expr $TEST_CYCLE*0] -clock clk [all_outputs]

group_path -name "Pipeline_Logic" -weight 5.0 -from [all_registers] -to [all_registers]
